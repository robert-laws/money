...
var PresentAnnuity = React.createClass({
  ...
  onClearValues: function(e) {
    e.preventDefault();
    var form = document.getElementById("PresentFV");
    form.reset();
    ...
    return (
      <Container className="topDiv">
        <Segment color="purple">
          <Header as="h2">Present Value of Ordinary Annuity</Header>
          <Divider />
          <Form id="PresentFV" onSubmit={this.onFormSubmit}>
