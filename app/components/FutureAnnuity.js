...
var FutureAnnuity = React.createClass({
  ...
  onClearValues: function(e) {
    e.preventDefault();
    var form = document.getElementById("AnnuityFV");
    form.reset();
  ...
  onFormSubmit: function(e, {formData}) {
    ...
    this.doAnnuityFV({formData});
  },
  doAnnuityFV: function(data) {
    ...
    return (
      <Container className="topDiv">
        <Segment color="purple">
          <Header as="h2">Future Annuity of Ordinary Annuity</Header>
          <Divider />
          <Form id="AnnuityFV" onSubmit={this.onFormSubmit}>
